...
## A student has cancelled their lesson with you.
...
<table width="100%" style="max-width:500px;">
    ...
    <tr>
        <td style="text-align: right; padding: 4px;">Student Name</td>
        <td style="padding-left: 10px;"><strong>{{ data_get($student, 'name') }}</strong></td>
    </tr>
