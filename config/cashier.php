...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Your Stripe Connect webhook secret is used to prevent unauthorized requests to
    | your Stripe Connect webhook handling controllers. The tolerance setting will
    | check the drift between the current time and the signed request's.
    |
    */
    ...
    */
    ...
    'currency' => env('CASHIER_CURRENCY', 'aud'),
